...
The above plot categorizes the depth of the quake into two categories. To learn how to add a legend to the plot, view [this article](https://davidpross.github.io/rscatter/articles/tabula-sapiens.html). To visualize the depth variable using a continuous color map leave it as a numeric variable.
