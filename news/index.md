...
- Add unit tests
- Enable color encoding based on values in the data for continuous and
  categorical data

## rscatter 0.0.1

- [MVP](https://en.wikipedia.org/wiki/Minimum_viable_product): create a
  scatterplot widget and statically specify color, size, and opacity for
  points.
